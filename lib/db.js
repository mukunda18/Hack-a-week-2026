...
export const createReport = async (report) => {
  ...
  try {
    ...
    const reportResult = await client.query(
      `INSERT INTO reports (
        office_id, ip_hash_id, bribe_amount, delay, report_week, confidence_score
      ) VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING *`,
      [
        report.office_id,
    ...
    if (err.code === '23505') {
      throw new Error('A report for this office and week already exists from this IP');
...
export const addReportRaw = async (report) => {
  ...
  const queryText = `
    INSERT INTO reports (
      office_id, ip_hash_id, bribe_amount, delay, report_week, confidence_score, created_at
    ) VALUES ($1, $2, $3, $4, $5, $6, $7)
    RETURNING *;
  `;
  const values = [
